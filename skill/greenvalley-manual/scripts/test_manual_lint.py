...
class ManualLintTests(unittest.TestCase):
    def setUp(self):
        ...
        validation["terminology"] = {"product_name": "LiDAR360MLS", "forbidden_variants": ["Lidar360MLS"]}
    ...
    def test_full_rule_profiles_cover_faq_catalog(self):
        expected = {"GVMD-PATH-CASE", "GVMD-HTML-BLANK-LINE", "GVMD-LIST-COMPAT", "GVMD-PARAGRAPH-LONG", "GVMD-IMAGE-WIDTH", "GVMD-HTML-IMG-SYNTAX", "GVMD-FILENAME-SPACE", "GVMD-IMAGE-DIMENSION", "GVMD-LINK-LEVEL", "GVMD-BARE-URL", "GVMD-PRODUCT-NAME", "GVMD-LOCALE-PUNCT", "GVMD-TERM-CASE", "GVMD-SPELLING", "GVMD-PATH-ABSOLUTE", "GVMD-TABLE-SYNTAX"}
    ...
    def test_exact_and_review_findings(self):
        ...
        (self.root / "en" / "Page.md").write_text("#Title#\n\n[target](target.md)\n\n<div align=center>\n<img src=\"images/shot.png\" \" width=\"555\">\n</div>\n\n1. Step\n\nLidar360MLS，text http://example.com " + "long " * 20 + "\n\n|a|b|\n|---|---|\n|1|\n", encoding="utf-8")
        rules = {finding.rule_id for finding in self.lint().findings}
        expected = {"GVMD-HEADING-SYNTAX", "GVMD-PATH-CASE", "GVMD-HTML-IMG-SYNTAX", "GVMD-HTML-BLANK-LINE", "GVMD-LIST-COMPAT", "GVMD-PRODUCT-NAME", "GVMD-LOCALE-PUNCT", "GVMD-BARE-URL", "GVMD-PARAGRAPH-LONG", "GVMD-TABLE-SYNTAX", "GVMD-IMAGE-DIMENSION", "GVMD-IMAGE-WIDTH-STEP"}
        self.assertTrue(expected <= rules, expected - rules)

    def test_code_and_inline_suppression(self):
        (self.root / "en").mkdir()
        (self.root / "en" / "Page.md").write_text("# Page\n\n<!-- gv-lint-disable-next-line GVMD-PRODUCT-NAME reason=\"UI source\" -->\nLidar360MLS\n\n~~~text\nLidar360MLS，http://example.com\n~~~\n", encoding="utf-8")
        product = [item for item in self.lint().findings if item.rule_id == "GVMD-PRODUCT-NAME"]
    ...
    def test_normal_parent_relative_image_is_not_reported_as_case_error(self):
        ...
        self.assertFalse(any(item.rule_id == "GVMD-PATH-CASE" for item in findings))
    ...
    def test_terminology_emphasis_table_spelling_and_locale_image_width(self):
        ...
        self.assertTrue({"GVMD-TERM-CASE", "GVMD-TERM-FORBIDDEN", "GVMD-EMPHASIS-SYNTAX", "GVMD-TABLE-STYLE", "GVMD-SPELLING", "GVMD-IMAGE-LOCALE-WIDTH"} <= rules)
    ...
    def test_zero_dependency_yaml_build_adapter_and_advisory_policy(self):
        ...
        (workspace / "workspace.yaml").write_text(f"schema_version: 1\nproduct:\n  profile: product-profile.yaml\nrepository:\n  root: {self.root.as_posix()}/repo\nmanual:\n  active_version: V1\ntasks:\n  root: manual-tasks\nvalidation:\n  build_adapters:\n    - id: smoke\n      command: [cmd, /c, exit, '0']\n      required: true\n", encoding="utf-8")
        (workspace / "product-profile.yaml").write_text("schema_version: 1\nmanual_layout:\n  content_directory: Main\nvalidation:\n  mode: advisory\n  publish_policy:\n    required_before_publish: false\n", encoding="utf-8")
        (task_dir / "task.yaml").write_text("schema_version: 1\ntarget:\n  document_path: Module\nvalidation:\n  mode: inherit\n  profile: release\n", encoding="utf-8")
