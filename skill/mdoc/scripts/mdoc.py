...
def parser():
    ...
    for name in ("status", "continue", "confirm-definition", "accept-screenshots", "submit-authoring", "confirm-final", "revise-output"):
    ...
    try:
        if args.command == "workspace":
            ...
            if args.task_action == "create":
                ...
                result = task_action(
                    args.workspace or Path.cwd(), args.task, args.task_action,
