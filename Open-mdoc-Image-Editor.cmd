...
set "MDOC_EDITOR=%~dp0skill\mdoc\scripts\standalone_image_editor.py"
if not exist "%MDOC_EDITOR%" set "MDOC_EDITOR=%USERPROFILE%\.codex\skills\mdoc\scripts\standalone_image_editor.py"
